package com.neon.mcp.server.computer.domain.service;

import com.neon.mcp.server.computer.domain.model.ComputerFunctionRequest;
import com.neon.mcp.server.computer.domain.model.ComputerFunctionResponse;
...
public class ComputerService {
    ...
    private String getWindowsSpecificInfo() {
        ...
        try {
            ...
            java.io.BufferedReader reader = new BufferedReader(new InputStreamReader(process.getInputStream(), "GBK"));
            String line;
