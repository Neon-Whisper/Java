package com.neon.mcp.server.csdn.test;
...
import com.neon.mcp.server.csdn.domain.service.CSDNArticleService;
...
import com.neon.mcp.server.csdn.types.utils.MarkdownConverter;
...
public class ApiTest {
    ...
    public void test_saveArticle() throws IOException {
        ...
        // 2. 调用接口
        Call<ArticleResponseDTO> call = csdnService.saveArticle(request);
