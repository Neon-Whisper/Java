...
public class MCPCSDNTest {
    ...
    @Test
    public void test_weixinNotice_easy() {
        String userInput = """  
                根据下面的信息进行：微信公众号消息通知：
                平台："CSDN"，
                主题："Java求职面试：从Spring Boot到微服务的技术探索"，
                描述："面试官是一位经验丰富且严肃的技术大牛，而谢飞机则是以幽默著称的“水货”程序员。：Elasticsearch用于存储，Logstash用于日志收集和传输。",
                跳转地址："https://blog.csdn.net/weixin_46755643/article/details/146798852"
                """;
